    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -top-[20%] -right-[15%] w-[700px] h-[700px] bg-linear-to-br from-blue-400/20 to-primary/10 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            y: [0, 40, 0],
          ...
          className="absolute top-[50%] -left-[15%] w-[500px] h-[500px] bg-linear-to-tr from-orange-300/15 to-yellow-200/10 rounded-full blur-3xl"
        />
        {/* Decorative grid */}
