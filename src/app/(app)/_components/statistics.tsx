    ...
    <section id="statistics" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.h2 variants={fadeUp} initial="initial" whileInView="animate" viewport={{ once: true }} className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">
            Data Sekolah & Sarana Prasarana
          </motion.h2>
          <motion.p variants={fadeUp} initial="initial" whileInView="animate" viewport={{ once: true }} className="text-muted-foreground text-lg">
            Gambaran umum distribusi sekolah dan kelengkapan data sarana prasarana di lingkungan Dinas Pendidikan Kabupaten Nias Selatan.
          </motion.p>
        </div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                `}>
                  <div className={`w-14 h-14 rounded-xl bg-background border border-border/50 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 group-hover:bg-${stat.color.replace('text-', '')}-50 dark:group-hover:bg-muted transition-all duration-300`}>
